...
public class AASMS_2604 {
    ...
    public void setUp() throws Exception {
        ...
        File app = new File(appDir, "RCMobile_7.2.0.1.187_RLZ_DEV_XIA_Automation.apk");

        // 1st device
        DesiredCapabilities capabilitiesDevice1 = new DesiredCapabilities();
        capabilitiesDevice1.setCapability("deviceName", "015d8bece817f415");
        capabilitiesDevice1.setCapability("platformVersion", "4.4");
